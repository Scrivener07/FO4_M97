Scriptname M97:Papyrus Const Native Hidden
import M97:Log
...
bool Function NewState(ScriptObject this, int stateID) Global
	If (this)
		...
		return true
	Else
		WriteUnexpectedValue("M97:Papyrus", "NewState", "this", "Cannot request state ID "+stateID+" on a none script.")
		return false
	EndIf
EndFunction
...
bool Function AwaitState(ScriptObject this, string statename = "Busy") Global
	...
	If (this)
		...
		EndIf
	Else
		WriteUnexpectedValue("M97:Papyrus", "AwaitState", "this", "The script cannot be none.")
		return false
	EndIf
EndFunction
...
bool Function BeginState(ScriptObject this, string statename = "Busy") Global
	...
	If (this)
		...
		EndIf
	Else
		WriteUnexpectedValue("M97:Papyrus", "BeginState", "this", "The script cannot be none.")
		return false
	EndIf
EndFunction
...
bool Function StateRunning(ScriptObject this) Global
	...
	Else
		WriteUnexpectedValue("M97:Papyrus", "StateRunning", "this", "The script cannot be none.")
		return false
	EndIf
EndFunction
...
bool Function ClearState(ScriptObject this) Global
	...
	If (this)
		...
		EndIf
	Else
		WriteUnexpectedValue("M97:Papyrus", "ClearState", "this", "The script cannot be none.")
		return false
	EndIf
EndFunction
...
bool Function ChangeState(ScriptObject this, string statename) Global
	...
	If (this)
		...
		EndIf
	Else
		WriteUnexpectedValue("M97:Papyrus", "ChangeState", "this", "The script cannot be none.")
		return false
	EndIf
EndFunction
